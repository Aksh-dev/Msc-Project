...
namespace VR  
{
	...
	public class VRSensor
	{
		...
		public VRSensor(int id, Vector3 dir)
		{
			ID = id;
			Direction = dir;
		}
	...
	public class Sensors : MonoBehaviour 
	{
		...
		private VRSensor[] longRangeSensorsArray; 
		private VRSensor[] shortRangeSensorsArray;

		private void Awake()
		{
			longRangeSensorsArray = new VRSensor[numLongRangeSensors];
			shortRangeSensorsArray = new VRSensor[numShortRangeSensors];
